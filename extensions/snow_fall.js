...
function init() {
	...
	scene = gviewer.impl.scene;
	console.log("scene = " + scene);
	console.log("gviewer = " + gviewer);
	//scene.add(camera);
...
class SnowfallExtension extends Autodesk.Viewing.Extension {
    ...
    load() {
        console.log('SnowfallExtension is loaded!');
		gviewer = this.viewer;
		init();
        return true;
    }
    unload() {
        console.log('SnowfallExtension is now unloaded!');
        return true;
    }
}

Autodesk.Viewing.theExtensionManager.registerExtension('SnowfallExtension', SnowfallExtension);
